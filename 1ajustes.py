...
#Agora entra as funções de lógica:
@st.cache_data(ttl=60)  # 60s de cache: quase sempre fresco
def carregar_eventos(url: str, dias_a_frente: int) -> list:
    ...
    eventos_formatados = []
    try:
        # Busca os eventos já expandidos no período
...
intervalo = col1.number_input("⏱️ Intervalo (minutos):", min_value=15, value=50, step=5)  # 50 = 1 crédito
